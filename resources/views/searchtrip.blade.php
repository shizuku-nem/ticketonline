    ...
    <div class="col-12 px-0">
      <form action="{{route('searchtrippost')}}" method="post">
        ...
        <div class="form-group ">
          ...
          <div class="form-group ">
            <label class="text-uppercase font-weight-bold" for="start_point">start_point</label>
            <input type="text" class="form-control rounded-0" id="start_point" placeholder="start_point" name="start_point">
          </div>
          <div class="form-group ">
              <label class="text-uppercase font-weight-bold" for="end_point">end_point</label>
              <input type="text" class="form-control rounded-0" id="end_point" placeholder="end_point" name="end_point">
            </div>
        <div class="form-group ">
